...
def extract_media(file_path: str, output_base: str = None) -> Tuple[str, List[str], str, str]:
    """
    ...
    logger.info(f"✅ Media extracted: {transcription.duration:.1f}s | {len(transcription.text)} chars")
